...
Mobile-friendly, shareable landing page to sell a Tern A7. Includes WhatsApp CTA and social previews.
...
4. Inject static OG/Twitter meta tags (for WhatsApp/Twitter previews):
   ...
   - After deploy: `python3 tools/inject_meta.py --base https://yaffol.github.io/tern-a7-sale/`
...
- Publishes at `https://yaffol.github.io/tern-a7-sale/`.
